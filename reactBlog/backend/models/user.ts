// legatura intre baza de date si node se face cu fisierele din Models-post.ts si user.ts
// ne importam interfata pe care o sa lucra, ne importam baza de date, ne importam modulul care imcripteaza parola si pachetele de mysql
